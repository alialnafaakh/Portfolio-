          ...
          <div className="hero-content" data-tilt onMouseMove={handleMouseMove} onMouseLeave={handleMouseLeave}>
            ...
            <div className="social-links">
              {content.about?.github_url && (
                <a href={content.about.github_url.startsWith('http') ? content.about.github_url : `https://${content.about.github_url}`} target="_blank" rel="noopener noreferrer" className="social-btn hover-trigger" aria-label="GitHub">
              ...
              {content.about?.linkedin_url && (
                <a href={content.about.linkedin_url.startsWith('http') ? content.about.linkedin_url : `https://${content.about.linkedin_url}`} target="_blank" rel="noopener noreferrer" className="social-btn hover-trigger" aria-label="LinkedIn">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
